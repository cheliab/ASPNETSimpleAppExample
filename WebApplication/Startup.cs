...
namespace WebApplication
{
    public class Startup
    {
        ...
        /// <summary>
        /// Пример с таймером
        /// Объясняется разница использования сервисов в конструкторе и методе InvokeAsync
        /// </summary>
        public void TimerExample(IApplicationBuilder app, IWebHostEnvironment env)
        {
